...
import {
    SET_KQI_FILTER_START,
    SET_KQI_FILTER_END,
    SET_KQI_FILTER_RF,
    SET_KQI_FILTER_MRF,
    SET_KQI_FILTER_CURRENT,
    SET_KQI_FILTER_HISTORICAL,
} from '../actions';
