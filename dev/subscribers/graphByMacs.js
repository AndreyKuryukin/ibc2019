...
module.exports = {
    ...
    get 'DEFA4672A173'() {
        return this._E4277126BF0B.map(actualize).map(replaceMac('DEFA4672A173')).map(decreaseKab(5.7))
    },
    get '2938749A3FD1'() {
    ...
    get 'DDEFFA45A832'() {
        return this._001B23324A56.map(actualize).map(replaceMac('DDEFFA45A832')).map(decreaseKab(5.1))
    },
    get '113593799543'() {
